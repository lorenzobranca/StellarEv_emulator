...
DATA_DIR  = "/export/data/vgiusepp/StellarEv_emulator/preprocessing_new/"
CKPT_DIR  = os.path.abspath("checkpoints_new/deeponet_params_new_time_diff/")
PLOTS_DIR = "./plots_new_time_diff/"
TIME_DIR  = "./preprocessing_new/"
...
output = 10**output
print('min max output before diff:', output.min(), output.max())
